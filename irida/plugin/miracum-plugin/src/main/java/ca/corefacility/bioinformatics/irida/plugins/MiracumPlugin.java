 ...
 */
public class MiracumPlugin extends Plugin {
	 ...
	 * for each pipeline).
	 */
	public static final AnalysisType MIRACUM = new AnalysisType("MIRACUM");

	public MiracumPlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class PluginInfo implements IridaPlugin {
		 ...
		 * 
		 * <pre>
		 * {@code <analysisType>MIRACUM</analysisType>}
		 * </pre>
		 * 
		...
		public UUID getDefaultWorkflowUUID() {
			return UUID.fromString("24b95252-08c0-4e6d-96d8-8845148f7cf4");
		}
		...
		public Optional<Color> getBackgroundColor() {
			return Optional.of(Color.decode("#F47174"));
		}
		...
		public Optional<AnalysisSampleUpdater> getUpdater(MetadataTemplateService metadataTemplateService,
			...
			return Optional.of(new MiracumPluginUpdater(metadataTemplateService, sampleService, iridaWorkflowsService));
		}
	}
}
