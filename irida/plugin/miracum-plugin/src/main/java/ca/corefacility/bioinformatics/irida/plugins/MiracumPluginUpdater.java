 ...
 */
public class MiracumPluginUpdater implements AnalysisSampleUpdater {
	...
	/**
	 * Builds a new {@link WeatherPluginUpdater} with the given services.
	 * 
	 ...
	 */
	public MiracumPluginUpdater(MetadataTemplateService metadataTemplateService, SampleService sampleService,
