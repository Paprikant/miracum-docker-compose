...
public class WeatherPlugin extends Plugin {
	 ...
	 * for each pipeline).
	 */
	public static final AnalysisType DEMO = new AnalysisType("DEMO");
	...
	public static class PluginInfo implements IridaPlugin {
		 ...
		 * 
		 * <pre>
		 * {@code <analysisType>DEMO</analysisType>}
		 * </pre>
		 * 
		...
		public UUID getDefaultWorkflowUUID() {
			return UUID.fromString("b90bb9e8-f286-4073-8802-a4c0db074451");
		}
		...
		public Optional<Color> getBackgroundColor() {
			return Optional.of(Color.decode("#ffc400"));
		}
		...
		public Optional<AnalysisSampleUpdater> getUpdater(MetadataTemplateService metadataTemplateService,
			...
			return Optional.of(new WeatherPluginUpdater(metadataTemplateService, sampleService, iridaWorkflowsService));
		}
	}
}
