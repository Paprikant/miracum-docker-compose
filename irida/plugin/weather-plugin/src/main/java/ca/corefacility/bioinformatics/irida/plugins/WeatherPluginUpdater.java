 ...
 */
public class WeatherPluginUpdater implements AnalysisSampleUpdater {
	 ...
	 */
	public WeatherPluginUpdater(MetadataTemplateService metadataTemplateService, SampleService sampleService,
